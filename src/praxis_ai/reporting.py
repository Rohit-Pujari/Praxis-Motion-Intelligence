...
def serialize_report(report: AnalysisReport) -> dict:
    return {
        ...
        "selected_condition": report.selected_condition,
        ...
        "joint_deviation": report.joint_deviation,
        "joint_overlay_colors": report.joint_overlay_colors,
        "model_prediction": report.model_prediction,
        "model_distances": report.model_distances,
        "deep_model_prediction": report.deep_model_prediction,
        "deep_model_confidence": round(report.deep_model_confidence, 1),
        "deep_joint_importance": report.deep_joint_importance,
